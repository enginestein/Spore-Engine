...
class Body3D:
    __slots__ = ('pos', 'vel', 'rot', 'ang_vel', 'mass', 'inv_mass',
                 'inertia', 'inv_inertia', 'shape', 'radius',
                 'color', 'restitution', 'friction', 'locked')
...
class Spring3D:
    __slots__ = ('a', 'b', 'rest_len', 'stiffness', 'damping')
